...
第 1 到第 4 講為第一批；2026-07-10 已依校對完成狀態擴充第 5、6 講。第 7 到第 10 講後續等筆記校對完成後，再逐批補進題庫。

## 3.1 課程來源

上課功能同樣以 `../02-雄女電資班考題整理/videos/` 為主要來源。每一份影片整理筆記，會先轉成一個「課程小節」，再連到對應觀念與題目。

第一版課程來源先使用第 1 到第 4 講，和第一版題庫範圍一致。2026-07-10 已擴充到第 6 講；後續第 7 到第 10 講完成校對後，再逐批加入課程與題目。
...
第一版原本只做第 1 到第 4 講，目標不是一次做完整網站，而是先讓學生開始練習，並驗證題目分級與弱點追蹤是否有效。第 5、6 講校對完成後，已於 2026-07-10 擴充進網站。
...
- 管理者登入。
- 課程清單與單一課程頁。
- 從第 1 到第 6 講建立第一批與第一輪擴充課程內容。
- 課程頁能執行 Python 範例。
- 記錄課程閱讀與完成狀態。
- 課程完成後進入對應練習。
- 從第 1 到第 6 講建立第一批與第一輪擴充題庫。
- 一次只顯示一題。
- 單選題、多選題、輸出預測題。
- 作答後立即顯示解析。
- 記錄作答結果。
...
- 隨 `02-雄女電資班考題整理` 後續校對，逐批加入第 7 到第 10 講。
- 補模擬考模式。
- 補錯題本。
- 補每日複習排程。
...
| 題庫來源還沒全部完成 | 已先用第 1 到第 6 講，後續逐批補完 |
